...
const liveSelections = [
  ...
  { label: "RGN", value: "2.05", active: false },
  { label: "Boost", value: "+12%", active: false },
] as const;
...
export default function PhoneMockup({
  ...
  return (
    ...
    >
      <div
        ref={frameRef}
        className="relative aspect-[370/760] w-full [transform-style:preserve-3d]"
      >
        <span
          aria-hidden
        ...
        <span
          aria-hidden
          className="pointer-events-none absolute inset-[4%] rounded-[3.75rem] bg-[radial-gradient(circle_at_18%_16%,rgba(92,167,223,0.2),transparent_28%),radial-gradient(circle_at_85%_18%,rgba(198,29,47,0.18),transparent_26%)] opacity-85 blur-3xl"
        />
        ...
        >
          ...
          >
            <span
              aria-hidden
              className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_24%_18%,rgba(92,167,223,0.16),transparent_24%),radial-gradient(circle_at_84%_14%,rgba(198,29,47,0.18),transparent_24%),linear-gradient(180deg,transparent,rgba(0,0,0,0.18))]"
            />
            <span
              aria-hidden
...
function DemoScreen({ title }: { title: string }) {
  return (
    <div className="relative flex h-full flex-col px-3 pb-[1rem] pt-[1.84rem] text-[var(--color-foreground)] sm:px-4 sm:pb-[1.15rem] sm:pt-[2.04rem]">
      <div className="pointer-events-none absolute inset-x-0 top-0 h-[36%] bg-[radial-gradient(circle_at_top,rgba(198,29,47,0.14),transparent_46%)]" />
      <StatusRow className="absolute inset-x-3 top-[0.9rem] z-10 sm:inset-x-4 sm:top-[1rem]" />
      ...
      <div className="relative flex h-full flex-col rounded-[2.6rem] border border-white/6 bg-[linear-gradient(180deg,rgba(255,255,255,0.02)_0%,rgba(255,255,255,0.01)_100%)] p-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] backdrop-blur-sm sm:p-4">
        ...
        <div className="mt-[0.8rem] grid grid-cols-5 gap-2">
          {shortcutItems.map((item) => (
            <ShortcutChip key={item.label} label={item.label} icon={item.icon} />
          ))}
        </div>

        <div className="mt-[0.7rem] flex-1 space-y-3">
          <LiveFocusCard />
          <FootballPreviewCard />
        </div>
...
function StatusRow({ className }: { className?: string }) {
  return (
    <div className={cn("flex items-center justify-between text-[0.62rem] font-semibold tracking-[0.03em] text-white/72", className)}>
      <span>9:41</span>
...
function ShortcutChip({
  ...
  return (
    <div className="flex min-w-0 flex-col items-center gap-1.5 rounded-[1rem] border border-white/7 bg-white/[0.045] px-2 py-2.5 text-center shadow-[inset_0_1px_0_rgba(255,255,255,0.05)]">
      <span className="flex h-8 w-8 items-center justify-center rounded-full bg-[linear-gradient(135deg,rgba(92,167,223,0.16),rgba(198,29,47,0.16))] text-[var(--color-primary-strong)]">
...
function LiveFocusCard() {
  return (
    <DemoCard
      className="bg-[linear-gradient(180deg,rgba(10,24,38,0.96)_0%,rgba(8,18,30,0.94)_100%),radial-gradient(circle_at_top_right,rgba(198,29,47,0.18),transparent_34%)]"
      accentClassName="bg-[radial-gradient(circle,rgba(198,29,47,0.32),transparent_68%)]"
    >
      ...
      <div className="mt-3 grid grid-cols-[1fr_auto] gap-3">
        ...
        <div className="flex items-end gap-1.5">
          <span className="h-8 w-1.5 rounded-full bg-[linear-gradient(180deg,rgba(92,167,223,0.22),rgba(92,167,223,0.92))]" />
          <span className="h-12 w-1.5 rounded-full bg-[linear-gradient(180deg,rgba(255,196,140,0.2),rgba(255,196,140,0.92))]" />
          <span className="h-16 w-1.5 rounded-full bg-[linear-gradient(180deg,rgba(198,29,47,0.16),rgba(198,29,47,0.96))]" />
        </div>
      </div>
...
function FootballPreviewCard() {
  return (
    <DemoCard
      className="bg-[linear-gradient(180deg,rgba(7,16,27,0.98)_0%,rgba(7,15,25,0.95)_100%),radial-gradient(circle_at_18%_18%,rgba(92,167,223,0.16),transparent_28%)]"
      accentClassName="bg-[radial-gradient(circle,rgba(92,167,223,0.24),transparent_70%)]"
    >
...
function BottomNav() {
  return (
    <div className="mt-2.5 grid grid-cols-5 gap-1 rounded-[1.35rem] border border-white/8 bg-black/20 p-1.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
        ...
        >
          <span
            className={cn(
              ...
              item.active && "bg-[linear-gradient(135deg,rgba(92,167,223,0.16),rgba(198,29,47,0.16))] text-[var(--color-primary-strong)]",
            )}
          >
  ...
  return (
    <div
      className={cn(
        ...
        active
          ? "border-[var(--color-primary)]/24 bg-[linear-gradient(180deg,rgba(198,29,47,0.16),rgba(198,29,47,0.08))]"
  ...
  switch (kind) {
    ...
    case "controller":
      return (
        <svg viewBox="0 0 20 20" fill="none" className={className} aria-hidden>
          ...
          />
          <path
            d="M7 9.7v2.2M5.9 10.8h2.2M13.55 10.1h.01M14.95 11.5h.01"
            stroke="currentColor"
            strokeWidth="1.4"
            strokeLinecap="round"
          />
    ...
    case "football":
      return (
        <svg viewBox="0 0 20 20" fill="none" className={className} aria-hidden>
          ...
          <path
            d="m6.8 9.1-2.1 1.4M13.2 9.1l2.1 1.4M8.6 13.1l-1.2 2M11.4 13.1l1.2 2"
            stroke="currentColor"
            strokeWidth="1.2"
            strokeLinecap="round"
          />
    ...
    case "home":
      return (
        <svg viewBox="0 0 20 20" fill="none" className={className} aria-hidden>
          <path
            d="m4.25 9.3 5.1-4.3a1 1 0 0 1 1.3 0l5.1 4.3V15a1 1 0 0 1-1 1h-2.7v-3.4H8V16H5.25a1 1 0 0 1-1-1V9.3Z"
            stroke="currentColor"
            strokeWidth="1.4"
            strokeLinejoin="round"
          />
